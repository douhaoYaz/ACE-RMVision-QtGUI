...
//    LightBarPair virual_pair_last;  //上次的虚拟灯条对，主要用于特殊情况下虚拟装甲板位置的保持
...
//    LightBarPairFinder finder_pair;
//    ArmorFinder finder_armor;
...
//     *@param data_tmp  读入的交互参数
//     */
//    TopDetector(cv::Mat& img_src, Setting& setting): Detector(img_src),
//            finder_pair({ 30, 400 }, { 20, 10000 }, 30),
//            finder_armor(5.5, 100),
//            classifier(setting.path_classifier_arm_caffe_net,
//            setting.path_classifier_arm_caffe_model),
//            is_useroi(setting.is_armor_useroi) { }
//#endif
...
//     *	@pair_target 目标装甲
//     */
//    void generateArmor(LightBarPairSet& set,std::vector<Armor>& arms, LightBarPair& pair_target);

//    /**
//     *@brief 从灯条对中获取点，用于角度解算
//     *@param pair_target 目标装甲
//     */
//    void getPoints(LightBarPair& pair_target);
