...
int main(int argc, char* argv[]) {
    ...
    if (mode == 0) {
        ...
        default: case ROBOT_INFANTRY:
            if (param2 != "")
                setting.setInfantryParameter("../../parameter/capture/"+param1+".xml");
            else
                setting.setInfantryParameter("../../parameter/capture/"+param1+".xml",
                        "../../parameter/capture/"+param2+".xml");
            break;
        case ROBOT_GUARD:
            if (param2 != "")
                setting.setGuardParameter("../../parameter/capture/"+param1+".xml");
            break;
        }
    }
    else if (mode == 1)
        setting.setVideoParameter("../../video/"+param1+".avi");
