...
public:
    ...
    AngleSolver(const cv::Mat& matrix_camera, const cv::Mat& matrix_coeffs_distortion,
            Setting& setting): mat_camera(matrix_camera),
            mat_coeffs_distortion(matrix_coeffs_distortion),
